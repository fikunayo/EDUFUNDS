          ...
          <b-navbar toggleable="lg" type="dark" variant="dark">
            ...
            <b-collapse id="nav-collapse" is-nav>
              <b-navbar-nav>
                ...
                <b-nav-item href="#campaign-form">Start a Campaign</b-nav-item>
                <b-nav-item href="#campaigns">FAQs</b-nav-item>
                <b-nav-item href="#campaigns">About</b-nav-item>
              </b-navbar-nav>
            </b-collapse>
          </b-navbar>
        </div>
        ...
        <v-layout text-xs-center wrap class="headline">
          <v-flex mb-4>
            ...
            <p class="subheading font-weight-bold">
              ...
              <br />
              Utilizing Ethereum for decentralized crowdfunding for the
              education sector.
            </p>
          </v-flex>
        </v-layout>
